...
{
    public partial class SalesClerkMessages : Form
    {
        public int Id;
        public string Date;
        public SalesClerkMessages()
        {
            InitializeComponent();
        ...
        private void SalesClerkMessages_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void send_Click(object sender, EventArgs e)
        {
            ...
            connection1.Open();
            string sql1 = "INSERT INTO Message(Position,[From],[To],Message,Date,Subject) VALUES('" + position.Text + "','" + Form1.SetValueForText6 + "','" + to.Text + "','" + textBox1.Text + "','" + Date + "','"+comboBox1.Text+"')";
        ...
        private void groupBox1_Enter(object sender, EventArgs e)
        {
            SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["Message"].ConnectionString);
            connection.Open();
            string sql = "SELECT Id,Position,[From],[To],Message,Date FROM Message   WHERE [From] LIKE '" + Form1.SetValueForText6 + "%' OR [To] LIKE '" + Form1.SetValueForText6 + "%'  ";
            SqlCommand command = new SqlCommand(sql, connection);
