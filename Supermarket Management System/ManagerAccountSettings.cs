...
{
    public partial class ManagerAccountSettings : Form
    {
        public ManagerAccountSettings()
        {
            InitializeComponent();
        }

        private void ManagerAccountSettings_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }

        private void back_Click(object sender, EventArgs e)//goes back to manager dashboard
        {
