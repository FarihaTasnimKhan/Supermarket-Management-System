...
{
    public partial class EmployeeAttendance_Admin_ : Form
    {
        public int Id;
        public string Date;
        public EmployeeAttendance_Admin_()
        {
            InitializeComponent(); 
            Date = DateTime.Today.ToString("dddd , MMM dd yyyy");
        }

        private void EmployeeAttendance_Admin__FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }

        private void groupBox1_Enter(object sender, EventArgs e)//shoes employee attendances in grid view
        {
        ...
        private void button2_Click(object sender, EventArgs e)//send reminder
        {
           ...
           // string timing = DateTime.Today.ToString("h:mm tt");
            ...
            connection.Open();
            string sql = "INSERT INTO Message(Position,[From],[To],Message,Date) VALUES('" + label7.Text + "','" + Form1.SetValueForText5 + "','" + label1.Text + "','" + textBox1.Text + "','" + Date+ "')";
            SqlCommand command = new SqlCommand(sql, connection);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)//employee table click 
        {
        ...
        private void button1_Click(object sender, EventArgs e)//fire employee
        {
            string status = "Fired";
            SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["EmployeeTable"].ConnectionString);
            connection.Open();
