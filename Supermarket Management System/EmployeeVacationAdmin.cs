...
{
    public partial class EmployeeVacationAdmin : Form
    {
        public int Id; public string Date;
        public EmployeeVacationAdmin()
        {
            InitializeComponent(); Date = DateTime.Today.ToString("dddd , MMM dd yyyy");
        }

        private void EmployeeVacationAdmin_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void groupBox1_Enter(object sender, EventArgs e)
        {
            ...
            connection.Open();
            string sql = "SELECT Id,Position,[From],[To],Message,Date,Subject FROM Message   WHERE [To] LIKE '" + Form1.SetValueForText5 + "%' AND Subject LIKE '" + subject + "%'  ";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            connection1.Open();
            string sql1 = "INSERT INTO Message(Position,[From],[To],Message,Date) VALUES('" + label6.Text + "','" + Form1.SetValueForText5 + "','" + label4.Text + "','" + message + "','" + Date + "')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            SqlConnection connection1 = new SqlConnection(ConfigurationManager.ConnectionStrings["Message"].ConnectionString);
            connection1.Open();
            string sql1 = "INSERT INTO Message(Position,[From],[To],Message,Date) VALUES('" + label6.Text + "','" + Form1.SetValueForText5 + "','" + label4.Text + "','" + message1 + "','" + Date + "')";
            SqlCommand command1 = new SqlCommand(sql1, connection1);
            int result1 = command1.ExecuteNonQuery();
            connection1.Close();
