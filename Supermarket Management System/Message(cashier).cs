...
{
    public partial class Message_cashier_ : Form
    {
        public int Id;
        public string Date;
        public Message_cashier_()
        {
            InitializeComponent(); 
        ...
        private void Message_cashier__FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void back_Click_1(object sender, EventArgs e)//back to cashier dashboard.
        {
        ...
        private void delete_Click_1(object sender, EventArgs e)//delete old messages
        {
        ...
        private void groupBox1_Enter_1(object sender, EventArgs e)
        {
            SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["Message"].ConnectionString);
            connection.Open();
            string sql = "SELECT Id,Position,[From],[To],Message,Date FROM Message   WHERE [From] LIKE '" + Form1.SetValueForText3 + "%' OR [To] LIKE '" + Form1.SetValueForText3 + "%'  ";
            SqlCommand command = new SqlCommand(sql, connection);
